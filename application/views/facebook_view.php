...
<html xmlns="http://www.w3.org/1999/xhtml" <?php echo facebook_xmlns()?>>
	...
	<body>
		...
		<?php else:?>
			...
			<h2><?php echo $user->name?> ( <a href="https://local.facebookoauth.com/loginflow/logout">Logout</a> )</h2>
			<fb:like></fb:like>
			<?php $result = $this->facebook->call('get', 'me', array('metadata' => 1));?>
			
		<a href="https://www.facebook.com/search/me/photos-commented" target="_blank">Comments on photos</a>
		<?php endif;?>
		</div>
		<div id="fb-root"></div>
